...
import net.playeranalytics.plan.PlanForgeComponent;
...
public class FabricMockComponent {
    ...
    private PlanForgeComponent component;
    ...
    private ForgeServerProperties mockServerProperties() {
        ForgeServerProperties propertiesMock = Mockito.mock(ForgeServerProperties.class);
